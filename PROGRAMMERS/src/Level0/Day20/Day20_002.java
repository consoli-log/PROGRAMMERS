...
public class Day20_002 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(solution(new String[] {"right", "right", "right", "right", "right", "left"}, new int[] {9, 5}))); // [3, 0]
    ...
    public static int[] solution(String[] keyinput, int[] board) {
        ...
        for (int i = 0; i < keyinput.length; i++) {
            ...
            if (answer[0] > board[0] / 2 && answer[0] > 0) {
                answer[0] = board[0] / 2 ;
            } else if (answer[0] < board[0] / 2 * -1 && answer[0] < 0) {
                answer[0] = board[0] / 2 * -1 ;
            }

            if (answer[1] > board[1] / 2 && answer[1] > 0) {
                answer[1] = board[1] / 2 ;
            } else if (answer[1] < board[1] / 2 * -1 && answer[1] < 0) {
